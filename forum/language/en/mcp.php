...
$lang = array_merge($lang, array(
	...
	'ADD_TOPIC_MODERATOR'	=> 'Add Topic Moderator',
	...
	'report_reasons'		=> array(
		...
		'DESCRIPTION' => array(
			...
			'SPAM'		=> 'The message advertises for a website or another product.',
			'ABUSE'		=> 'The message is abusive or trolling.',
			'OFF_TOPIC'	=> 'The message is off topic.',
			'NSFW'		=> 'The message is pornographic or otherwise blatantly obscene.',
			'OOPS'		=> 'The message is an accidental double-post, or was made from the wrong account.',
			'OTHER'		=> 'The message does not fit into any other category, please use the further information field.',
		)
	),
));
