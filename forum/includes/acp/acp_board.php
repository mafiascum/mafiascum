			...
			case 'settings':
				$display_vars = array(
					...
					'vars'	=> array(
						...
						'mafia_forums_id'		=> array('lang' => 'MAF_FORUM',			'validate' => 'int:0',		'type' => 'text:4:6', 'explain' => true),
			...
			case 'features':
				$display_vars = array(
					...
					'vars'	=> array(
						...
						'allow_account_switching'=> array('lang'=> 'YES_ACCOUNT_SWITCHING',	'validate' => 'bool',	'type' => 'radio:yes_no', 'explain' => false),
			...
			case 'post':
				$display_vars = array(
					...
					'vars'	=> array(
						...
						'enable_multiquote'		=> array('lang' => 'ENABLE_MULTIQUOTE',		'validate' => 'bool',		'type'
						=> 'radio:yes_no', 'explain' => true),
						'legend3'					=> 'ACP_SUBMIT_CHANGES',
					)
				);
			break;
			...
			case 'signature':
				$display_vars = array(
					...
					'vars'	=> array(
						...
						'disabled_sig_bbcodes'		=> array('lang' => 'DISABLED_SIG_BBCODES',	'validate' => 'string', 'type' => 'text:40:150', 'explain' => true),
