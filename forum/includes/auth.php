...
/*					This is uncommented, because i suspect this being slightly wrong due to mixed permission classes being possible
	...
	*/
	function login($username, $password, $autologin = false, $viewonline = 1, $admin = 0, $switch = false)
	{
		...
		{
			$login = $method($username, $password, $user->ip, $user->browser, $user->forwarded_for, $switch);
