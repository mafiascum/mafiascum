	...
	while ($row = $db->sql_fetchrow($result))
	{
		...
		switch ($row['user_inactive_reason'])
		{
			...
			case INACTIVE_IPFLAG:
				$row['inactive_reason'] = $user->lang['INACTIVE_REASON_IPFLAG'];
			break;
			case INACTIVE_EMAILFLAG:
				$row['inactive_reason'] = $user->lang['INACTIVE_REASON_EMAILFLAG'];
			break;
			case INACTIVE_SPAMFLAG:
				$row['inactive_reason'] = $user->lang['INACTIVE_REASON_SPAMFLAG'];
			break;
			case INACTIVE_PASSWORDFLAG:
				$row['inactive_reason'] = $user->lang['INACTIVE_REASON_PASSWORDFLAG'];
			break;
		}
