...
$result = mysql_query("SELECT * FROM tempPostTotalsPerMonth ORDER BY interval_datetime ASC", $connection);
...
while($row = mysql_fetch_assoc($result)) {
	...
	$rootArray[] = array($row['interval_datetime'], (int)$row['total_posts']);
	$count++;
}
...
$(document).ready(function(){
	var plot2 = $.jqplot ('Chart_PPM', <?php echo($jsonArray);?>,
	{
...
<div class="example-plot" id="Chart_PPM"></div>
